...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | DApples")[0];
}
  ...
  var loop = function () {
    ...
    if (now > 1000 + lastTime) {
      ...
      if (fps <= 5) {
        ...
        var kd = `<span style="color:red">3帧电竞😖</span>`
      } else if (fps <= 25) {
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://tuchuang.voooe.cn/images/2023/12/22/defaultbg.webp);
    --darkmode-bg:url(https://tuchuang.voooe.cn/images/2023/12/22/darkmode.webp);
    --mobileday-bg: url(https://tuchuang.voooe.cn/images/2023/12/22/phonelight.webp);
    --mobilenight-bg: url(https://tuchuang.voooe.cn/images/2023/12/22/phonedark.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
